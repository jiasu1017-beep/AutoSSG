...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("=" * 60)
        print("用法:")
        print("  python sausg_open.py <模型文件> [模块名称] [软件目录]")
        print()
        print("参数:")
        ...
        print()
        print("示例:")
        print('  python sausg_open.py "F:\\00AI\\AutoSSG\\Test\\Example.ssg"')
        print('  python sausg_open.py "F:\\00AI\\AutoSSG\\Test\\Example.ssg" 隔震')
        print('  python sausg_open.py "F:\\00AI\\AutoSSG\\Test\\Example.ssg" zeta')
        print('  python sausg_open.py "F:\\00AI\\AutoSSG\\Test\\Example.ssg" 非线性 "D:\\SAUSG2026"')
        print()
        list_modules()
        sys.exit(0)
