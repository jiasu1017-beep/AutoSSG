...
# 用减震模块打开
python .claude/skills/scripts/sausg_open.py Project/Example2.ssg zeta

# 用指定版本的软件打开
python .claude/skills/scripts/sausg_open.py Project/Example2.ssg 非线性 "D:\SAUSG2026"
```
